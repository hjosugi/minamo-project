...
REQUIRED = [
    ...
    'docs/benchmarks/multi-camera-fusion.md',
    'docs/benchmarks/multi-camera-fusion.ja.md',
    'scripts/bench-multicam-fusion.ts',
    'src/core/multiCamera.ts',
    'docs/research/ble-midi-drum-sticks.md',
    'docs/research/ble-midi-drum-sticks.ja.md',
    'src/core/bleMidiStick.ts',

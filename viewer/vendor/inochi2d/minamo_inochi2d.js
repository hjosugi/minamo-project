/* @ts-self-types="./minamo_inochi2d.d.ts" */
...
export class InoxModel {
     ...
     */
    update(delta_time) {
        const ret = wasm.inoxmodel_update(this.__wbg_ptr, delta_time);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./minamo_inochi2d_bg.js": import0,
    };
}

const InoxModelFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_inoxmodel_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('minamo_inochi2d_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
